...
int PauseScene::run(sf::RenderWindow &window)
{
	...
	while (window.isOpen())
	{
		...
		while (window.pollEvent(event))
		{
			...
			{
				resumeButton->setTexture(resumeTexture); resumeButtonS = true; 
			}
			...
			{ 
				mainMenuButton->setTexture(mainMenuTexture); mainMenuButtonS = true; 
			}
		}
